Puppet::Type.newtype(:network_interface) do
  ...
  ensurable do
    desc "The state of the interface, e.g. up or down"

    newvalue(:up) do
      if @resource.provider and @resource.provider.respond_to?(:up)
    ...
    newvalue(:down) do
      if @resource.provider and @resource.provider.respond_to?(:down)
